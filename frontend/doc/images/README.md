...
| `04b-predict-lung.png` | prediction.md |
| `04c-predict-breast.png` | prediction.md |
| `05-predict-result.png` | prediction.md |
| `06-predict-brain.png` | prediction.md |
...
Recommended: PNG or WebP, ~1200–1600px wide for full-page shots.

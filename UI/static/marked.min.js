                ...
                (t.table = function (e) {
                    ...
                    if (e) {
                        ...
                        if (t.header.length === t.align.length) {
                            t.raw = e[0];
                            for (
                                var u, n, r, i = t.align.length, s = 0;
                                s < i;
                                s++
                            )
                                /^ *-+: *$/.test(t.align[s])
                            ...
                            for (i = t.rows.length, s = 0; s < i; s++)
                                t.rows[s] = d(t.rows[s], t.header.length).map(
                                    function (e) {
                                        return { text: e };
                                    }
                                );
                            for (i = t.header.length, u = 0; u < i; u++)
                                t.header[u].tokens = this.lexer.inline(
                                    t.header[u].text
                                );
                ...
                (t.codespan = function (e) {
                    ...
                    if (e)
                        return (
                            ...
                            (u = /^ /.test(n) && / $/.test(n)),
                            (n = A(
                                (n = t && u ? n.substring(1, n.length - 1) : n),
                                !0
                            )),
                ...
                (t.url = function (e, t) {
                    ...
                    if ((u = this.rules.inline.url.exec(e))) {
                        if ("@" === u[2])
                            r =
                                "mailto:" +
                                (n = A(this.options.mangle ? t(u[0]) : u[0]));
                        else {
                            for (
                                ;
                                (i = u[0]),
                                    (u[0] = this.rules.inline._backpedal.exec(
                                        u[0]
                                    )[0]),
                                    i !== u[0];
            ...
            return (
                    ...
                    for (
                        ...
                        if (
                            ...
                            if ((u = this.tokenizer.space(r)))
                                ...
                                var l =
                                    "Infinite loop on byte: " + r.charCodeAt(0);
                ...
                (n.inlineTokens = function (r, t) {
                    ...
                    for (
                        ;
                        null !=
                        (n = this.tokenizer.rules.inline.blockSkip.exec(a));
                    ...
                    for (
                        ;
                        null !=
                        (n = this.tokenizer.rules.inline.escapedEmSt.exec(a));
                        ...
                        (a =
                            ...
                            "++" +
                            a.slice(
                                this.tokenizer.rules.inline.escapedEmSt
                                    .lastIndex
                            )),
                    ...
                    for (var u, n, r = "", i = e.length, s = 0; s < i; s++)
                        if (
                            ...
                            this.options.extensions &&
                                ...
                                (!1 !==
                                    (n = this.options.extensions.renderers[
                                        u.type
                                    ].call({ parser: this }, u)) ||
                                    ![
                                        "escape",
        ...
        return function (e, u, n) {
            ...
            if (u.async)
                return Promise.resolve(u.hooks ? u.hooks.preprocess(e) : e)
                    ...
                    .then(function (e) {
                        return u.walkTokens
                            ? Promise.all(I.walkTokens(e, u.walkTokens)).then(
                                  function () {
                                      return e;
                                  }
                              )
            ...
            try {
                ...
                var h = f(e, u),
                    p =
                        (u.walkTokens && I.walkTokens(h, u.walkTokens),
                        g(h, u));
                ...
                if (
                    ...
                    s.extensions &&
                        (s.extensions.forEach(function (r) {
                            ...
                            r.childTokens &&
                                (D.childTokens[r.name] = r.childTokens);
                        }),
                        (e.extensions = D)),
                    s.renderer)
                ) {
                    ...
                    switch (((a = a.concat(l.call(I, t))), t.type)) {
                        ...
                        default:
                            ...
                            I.defaults.extensions.childTokens[t.type]
                                ...
                                : t.tokens &&
                                  (a = a.concat(I.walkTokens(t.tokens, l)));
                    }
                })();
            return a;
        }),
